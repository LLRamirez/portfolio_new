...
export default function Photography() {
  ...
  const newImages = [
    ...
    { url: "/static/images/crownb.jpg", caption: "Pretty much me in a different form - Philadelphia, PA"},
    ...
    { url: "/static/images/buzz.jpg", caption: "Fresh cut with a design, I sometimes miss feeling the AC on my skull - Bangok, TH"},
    ...
    { url: "/static/images/india.jpg", caption: "Got my fortune told & learned a lil about astrology in India - Rajistan, India"},
    { url: "/static/images/menlonshaman.jpg", caption: "Last ceremony, ready to break that ayahusca diet - Maca, EC"},
    { url: "/static/images/cave.jpg", caption: "Took us 8 hours to get to the end of the cave - Chiang Rai"},
    { url: "/static/images/namyo.jpg", caption: "Named her Namyo, after a Japaense buddisht chant - Jersey City, JC"},
    { url: "/static/images/PRAlma.jpg", caption: "Street art was everywhere- San Juan, PR"},
    { url: "/static/images/byebkk.jpg", caption: "Farewell Bangkok with friends - Bangkok, TH"},
    ...
    { url: "/static/images/boatbkk.jpg", caption: "Took this on a beautiful day in the south - Koh Tao, TH"},
    { url: "/static/images/drinbarc.jpg", caption: "Clicked as soon as we met, Dominican mother & daughter ( Sandy - Supermodel) who & run own a bar - Barcelona, SP"},
