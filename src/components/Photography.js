...
export default function Photography() {
  ...
  const newImages = [
    ...
    { url: "/static/images/shaman.jpg", caption: "Shaman - Maca, EC"},
    ...
    { url: "/static/images/melonshaman.jpg", caption: "Lois, Shaman & I, last ceremony - Maca, EC"},
    { url: "/static/images/cave.jpg", caption: "cave - NV"},
